...
export const MOUNTAINS: MapPoint[] = [
  // --- KIVRIM DAĞLARI ---
  // Kuzey Anadolu
  { id: "kure", name: "Küre (İsfendiyar)", type: "kivrim", lng: 33.6, lat: 41.8 },
  { id: "ilgaz", name: "Bolu-Ilgaz", type: "kivrim", lng: 33.7, lat: 41.0 },
  { id: "koroglu", name: "Köroğlu Dağları", type: "kivrim", lng: 31.8, lat: 40.6 },
  { id: "canik", name: "Canik Dağları", type: "kivrim", lng: 36.5, lat: 41.0 },
  { id: "giresun", name: "Giresun Dağları", type: "kivrim", lng: 38.4, lat: 40.6 },
  { id: "zigana", name: "Zigana Dağları", type: "kivrim", lng: 39.4, lat: 40.6 },
  { id: "soganli", name: "Soğanlı Dağları", type: "kivrim", lng: 40.2, lat: 40.5 },
  { id: "kackar", name: "Kaçkar Dağları", type: "kivrim", lng: 41.1, lat: 40.8 },
  { id: "cimen", name: "Çimen Dağları", type: "kivrim", lng: 39.3, lat: 39.9 },
  { id: "kop", name: "Kop Dağları", type: "kivrim", lng: 40.2, lat: 40.0 },
  { id: "mescit", name: "Mescit Dağları", type: "kivrim", lng: 41.0, lat: 40.4 },
  { id: "yalnizcam", name: "Yalnızçam Dağları", type: "kivrim", lng: 42.2, lat: 41.2 },
  { id: "allahuekber", name: "Allahuekber Dağları", type: "kivrim", lng: 42.5, lat: 40.6 },
  
  // Toroslar
  { id: "akdag", name: "Akdağ", type: "kivrim", lng: 29.5, lat: 36.5 },
  { id: "bey_daglari", name: "Bey Dağları", type: "kivrim", lng: 30.1, lat: 36.6 },
  { id: "barla", name: "Barla Dağı", type: "kivrim", lng: 30.7, lat: 38.0 },
  { id: "geyik", name: "Geyik Dağları", type: "kivrim", lng: 32.1, lat: 36.9 },
  { id: "bolkar", name: "Bolkar Dağları", type: "kivrim", lng: 34.5, lat: 37.3 },
  { id: "aladaglar", name: "Aladağlar", type: "kivrim", lng: 35.1, lat: 37.8 },
  { id: "tahtali", name: "Tahtalı Dağları", type: "kivrim", lng: 36.1, lat: 38.5 },
  { id: "binboga", name: "Binboğa Dağları", type: "kivrim", lng: 36.6, lat: 38.3 },
  { id: "cilo", name: "Cilo Dağları", type: "kivrim", lng: 44.0, lat: 37.5 },
  
  // Diğer Kıvrım
  { id: "yildiz", name: "Yıldız (Istranca)", type: "kivrim", lng: 27.5, lat: 41.8 },
  { id: "koru", name: "Koru Dağları", type: "kivrim", lng: 26.8, lat: 40.7 },
  { id: "samanli", name: "Samanlı Dağları", type: "kivrim", lng: 29.5, lat: 40.6 },
  { id: "sundiken", name: "Sündiken Dağları", type: "kivrim", lng: 31.0, lat: 39.9 },
  { id: "sultan", name: "Sultan Dağları", type: "kivrim", lng: 31.3, lat: 38.3 },
  { id: "hinzir", name: "Hınzır Dağları", type: "kivrim", lng: 36.2, lat: 39.0 },
  { id: "tecer", name: "Tecer Dağları", type: "kivrim", lng: 37.2, lat: 39.5 },
  { id: "mercan", name: "Mercan Dağları", type: "kivrim", lng: 39.3, lat: 39.5 },

  // --- KIRIK DAĞLAR ---
  { id: "kaz", name: "Kaz Dağları", type: "kirik", lng: 26.8, lat: 39.7 },
  { id: "madra", name: "Madra Dağları", type: "kirik", lng: 27.1, lat: 39.3 },
  { id: "yunt", name: "Yunt Dağları", type: "kirik", lng: 27.2, lat: 38.8 },
  { id: "bozdaglar", name: "Bozdağlar", type: "kirik", lng: 28.0, lat: 38.3 },
  { id: "aydin", name: "Aydın Dağları", type: "kirik", lng: 27.8, lat: 38.0 },
  { id: "mentese", name: "Menteşe Dağları", type: "kirik", lng: 28.3, lat: 37.2 },
  { id: "amanos", name: "Amanos (Nur)", type: "kirik", lng: 36.3, lat: 36.7 },

  // --- VOLKANİK DAĞLAR ---
  { id: "karadag", name: "Karadağ", type: "volkanik", lng: 33.1, lat: 37.4 },
  { id: "karacadag_ic", name: "Karacadağ (İç And)", type: "volkanik", lng: 32.8, lat: 38.9 }, // Konya civarı
  { id: "karacadag_gd", name: "Karacadağ (G.Doğu)", type: "volkanik", lng: 39.8, lat: 37.7 },
  { id: "hasan", name: "Hasan Dağı", type: "volkanik", lng: 34.1, lat: 38.1 },
  { id: "melendiz", name: "Melendiz Dağı", type: "volkanik", lng: 34.3, lat: 38.1 },
  { id: "erciyes", name: "Erciyes Dağı", type: "volkanik", lng: 35.4, lat: 38.5 },
  { id: "nemrut_bitlis", name: "Nemrut Dağı (Bitlis)", type: "volkanik", lng: 42.2, lat: 38.6 },
  { id: "suphan", name: "Süphan Dağı", type: "volkanik", lng: 42.8, lat: 38.9 },
  { id: "tendurek", name: "Tendürek Dağı", type: "volkanik", lng: 43.8, lat: 39.3 },
  { id: "kucuk_agri", name: "Küçük Ağrı Dağı", type: "volkanik", lng: 44.5, lat: 39.6 },
  { id: "buyuk_agri", name: "Büyük Ağrı Dağı", type: "volkanik", lng: 44.3, lat: 39.7 },
  { id: "uludag", name: "Uludağ (Batolit)", type: "volkanik", lng: 29.2, lat: 40.0 },
];
